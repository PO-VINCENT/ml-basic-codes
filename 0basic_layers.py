...
import numpy as np
import copy
from active_function import Sigmoid, ReLU, SoftPlus, LeakyReLU,TanH, ELU, SELU, Softmax
...
class Layer(object):
    ...
    def forward_pass(self, X, traininig):
...
class Dense(Layer):
    ...
    def forward_pass(self, X, traininig=True):
        self.layer_input = X 
